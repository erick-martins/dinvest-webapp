...
export default function StressTest() {
	...
	return (
		<>
			<h3>
				{chartCount} Charts * 10 Series * 20 Datums ({chartCount * seriesCount * datumCount} data
				elements) w/ Synced Cursors & Series Highlighting
			</h3>
			<br />

			<p>NOTE: This example is best viewed in production for maximum performance.</p>
